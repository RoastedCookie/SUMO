...
public class SpawnManager : MonoBehaviour
{
    ...
    void SpawnEnemyWave(int waveNumber) //instead of enemiesToSpawn i have written waveNumber
    {
        for (int i = 0; i < waveNumber; i++) //instead of enemiesToSpawn i have written waveNumber
        {
